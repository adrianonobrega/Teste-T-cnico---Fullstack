...
exports.userUpdateController = exports.userListOneController = exports.userLoginController = exports.userListController = exports.userDeleteController = exports.userCreateController = void 0;
...
var userCreateController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, phone, password, newUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, email = _a.email, phone = _a.phone, password = _a.password;
                return [4 /*yield*/, (0, userCreate_services_1.userCreateServices)({ name: name, email: email, phone: phone, password: password })];
            case 1:
                newUser = _b.sent();
...
var userListController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, userList_services_1.userListService)()];
            case 1:
                users = _a.sent();
...
var userListOneController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, userListOne_services_1.userListOneService)(id)];
            case 1:
                users = _a.sent();
                res.status(200).json(users);
                return [2 /*return*/];
...
var userUpdateController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, email, phone, password, name, newUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                _a = req.body, email = _a.email, phone = _a.phone, password = _a.password, name = _a.name;
                return [4 /*yield*/, (0, userUpdate_services_1.userUpdateService)({ id: id, email: email, phone: phone, password: password, name: name })];
            case 1:
                newUser = _b.sent();
