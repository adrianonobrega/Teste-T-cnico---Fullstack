...
exports.contactDeleteController = exports.contactUpdateController = exports.contactListOneController = exports.contactListController = exports.contactCreateController = void 0;
...
var contactOneList_services_1 = require("../services/contact/contactOneList.services");
...
var contactCreateController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, _a, email, phone, name_1, contact, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                user_id = req.params.user_id;
                _a = req.body, email = _a.email, phone = _a.phone, name_1 = _a.name;
                return [4 /*yield*/, (0, contactCreate_services_1.contactCreateServices)({ user_id: user_id, email: email, phone: phone, name: name_1 })];
            case 1:
                contact = _b.sent();
...
var contactListController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, contactList_services_1.contactListService)()];
            case 1:
                contact = _a.sent();
...
var contactListOneController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, contactOneList_services_1.contactOneListService)(user_id)];
            case 2:
                contact = _a.sent();
                res.status(200).json(contact);
                return [3 /*break*/, 4];
...
var contactUpdateController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, email, phone, name_2, contact, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                id = req.params.id;
                _a = req.body, email = _a.email, phone = _a.phone, name_2 = _a.name;
                return [4 /*yield*/, (0, contactUpdate_services_1.contactUpdateService)({ id: id, email: email, phone: phone, name: name_2 })];
            case 1:
                contact = _b.sent();
                res.status(201).json(contact);
                return [3 /*break*/, 3];
